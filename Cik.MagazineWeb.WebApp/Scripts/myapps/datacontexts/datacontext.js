define('datacontext',
    ['datacontext.entityset', 'dataservice', 'model', 'model.mapper'],
    function (entitySet, dataservice, model, modelmapper) {
        var dashboard = new entitySet.EntitySet(
                dataservice.dashboard.getCategories,
                modelmapper.category,
                model.Category.Nullo,
                dataservice.dashboard.getCategories);
